...
export default function ExperienceCard({ card }: ExperienceCardProps) {
  return (
    <div className="flex space-x-3 2xl:mr-4 2xl:mt-8 2xl:block 2xl:space-x-0">
      <div
        className="mt-4 w-52 h-36 rounded-lg p-10 align-middle flex justify-center items-center"
